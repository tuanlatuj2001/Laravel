    ...
    <div class="card">
        ...
        <div class="row">
            ...
            <div class="card-body col-12">
                <form action="{{url('admin/asset/store')}}" method="POST">
                    @csrf
                    ...
                    <div class="input-group mb-3 col-6">
                        ...
                        <select class="form-control" id="" name="categorie_id">
                            ...
                            <option value="{{ $c->id }}">{{ $c->catagorie_name }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="row">
                    ...
                    <div class="input-group mb-3 col-6">
                        ...
                        <select class="form-control" id="" name="condition">
                            ...
                            <option value="0">NONE-EXISTENT (Asset abandoned or no longer exists)</option>
                            <option value="1">VETY GOOD (Only normal maintenace required)</option>
                            <option value="2">GOOD (Minor maintenace required 5%)</option>
                            <option value="3">FAIR (Signficant maintenace required 10-20%)</option>
                            <option value="4">FAIR (Signficant renewal/upgrade required 20-40%)</option>
                            <option value="5">UNSERVICEABLE (Over 50% of asset required replacement)</option>
